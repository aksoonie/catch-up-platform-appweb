...
namespace catch_up_platform2.News.Model.Aggregates;

/// FavoriteSource Aggregate
/// <summary>
///  This class represents the FavoriteSource aggregate. It is used to store
///  the favorite sources of a user.
/// </summary>
/// 
